      ...
      <div className=" flex items-center justify-between">
        <div className="flex">
          ...
          <ul className="border-l border-gray-700 m-2 flex space-x-3 items-center pl-2">
            <li>
              <a href="https://github.com/drmas" target="_blank" rel="noreferrer">
                <svg
                  ...
                  className="text-gray-500 w-6 h-6 fill-current"
                >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/drmohamedshaban/"
                target="_blank"
                rel="noreferrer"
              >
                <svg
            ...
            <li>
              <a href="https://twitter.com/DrMShaban" target="_blank" rel="noreferrer">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
